...
fun main() {
    ...
    val todosOsPedidosNaoPagamFrete: Map<Boolean, List<Pedido>> = pedidos.groupBy { pedido: Pedido -> pedido.valor > 50.0 }
    ...
    println(agenda)
    println("******************Imprime todos nomes que iniciam com a letra A  ******************")
    println(agenda['A'])
